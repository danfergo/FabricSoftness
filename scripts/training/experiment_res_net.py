...
res_net = ResNet50(include_top=False, weights='imagenet', input_tensor=None, input_shape=(224, 224, 3))
print (res_net.input.shape)
print (res_net.output.shape)
...
input = res_net.input
# vgg16 goes here
fc1 = Conv2D(100, (7,7))(res_net.output)
...
experiment_name = 'experiment_res_net'
